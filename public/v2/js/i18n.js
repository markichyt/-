...
const uk = {
  ...
  cards: {
    ...
    assessment: {
      ...
      serviceFallback: 'Загальне',
      cvCtaTitle: '📄 Завантажте резюме — і AI складе ваш профіль за вас',
      cvCtaBody: 'Досвід, освіта, сертифікати, відомі справи й досягнення витягуються автоматично. Це піднімає силу профілю приблизно на 30%.',
...
const ru = {
  ...
  cards: {
    ...
    assessment: {
      ...
      serviceFallback: 'Общее',
      cvCtaTitle: '📄 Загрузите резюме — и AI составит ваш профиль за вас',
      cvCtaBody: 'Опыт, образование, сертификаты, известные дела и достижения извлекаются автоматически. Это поднимает силу профиля примерно на 30%.',
