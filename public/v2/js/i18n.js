...
const uk = {
  ...
  pricing: {
    ...
    features: {
      ...
      google: 'Просування вашого імені та профілю в Google',
      manager_ext: 'Персональний менеджер із розширеною підтримкою',
      manager_247: '24/7 персональний менеджер для швидкого заробітку',
      exclusive_smm: 'Ексклюзивне просування в соцмережах',
      own_services: 'Просування власних послуг',
      ai_google: 'AI-модуль для реклами в Google',
      ai_meta: 'AI-модуль для реклами в Meta',
      ai_monitoring: 'AI-моніторинг конкурентів',
      crm: 'Система для роботи з клієнтами та заявками',
      referral: 'Заробіток за реферальним кодом',
      messenger: 'Захищений месенджер із записом розмов',
      private_chat: 'Закритий чат для спеціалістів',
      rating_boost: 'Підвищення рейтингу за попереднім досвідом'
    },
    badges: {
      new: 'НОВЕ',
      more_4x: '4x більше',
...
const ru = {
  ...
  pricing: {
    ...
    features: {
      ...
      google: 'Продвижение вашего имени и профиля в Google',
      manager_ext: 'Персональный менеджер с расширенной поддержкой',
      manager_247: '24/7 персональный менеджер для быстрого заработка',
      exclusive_smm: 'Эксклюзивное продвижение в соцсетях',
      own_services: 'Продвижение собственных услуг',
      ai_google: 'AI-модуль для рекламы в Google',
      ai_meta: 'AI-модуль для рекламы в Meta',
      ai_monitoring: 'AI-мониторинг конкурентов',
      crm: 'Система для работы с клиентами и заявками',
      referral: 'Заработок по реферальному коду',
      messenger: 'Защищённый мессенджер с записью разговоров',
