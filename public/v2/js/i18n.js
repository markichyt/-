...
const uk = {
  ...
  cards: {
    ...
    diagnosis: {
      situationLabel: 'Ваша ситуація',
      lostEyebrow: 'Ви втрачаєте щомісяця',
      lostCap: 'це {low}–{high} клієнтів, які зараз ідуть до інших юристів',
      yearlyLabel: 'За рік це',
      hoursChip: 'годин на місяць на пошук клієнтів',
      noTimeChip: 'годин на пошук — ви ростете лише на рекомендаціях',
      clientsChip: 'клієнтів щомісяця проходять повз вас',
      fixTitle: 'ЩО ЦЕ ВИРІШИТЬ',
      forLabel: 'Розраховано для:',
      caseLabel: 'середній чек справи:',
      cta: 'Показати рішення →',
      ...
      branch: {
        few_leads: {
          ...
          fix: 'Готові заявки від клієнтів у ваших напрямах + AI-просування в Google і рекламі.'
        },
        no_deals: {
          ...
          fix: 'Сильний публічний профіль, підвищення рейтингу за минулим досвідом і топ у Google за вашим іменем.'
        },
        routine: {
          ...
          fix: 'AI-аватар і контент-завод ведуть ваш профіль і соцмережі за вас, поки ви працюєте зі справами.'
        },
        no_system: {
          ...
          fix: 'CRM, захищений месенджер і AI-моніторинг — усі звернення в одному місці, нічого не втрачається.'
        }
      }
    },
    cta: {
    ...
    assessment: {
      ...
      tabBioNote: 'від 3 000 символів',
      cvPlaceholder: 'Натисніть, щоб обрати файл',
      cvHint: '.pdf / .doc / .docx',
      bioPh: 'Розкажіть про свій досвід, освіту, спеціалізацію, відомі справи, сертифікати й нагороди. Що більше деталей — то сильніший профіль складе AI.',
      charCount: '{n} / {target} символів',
      finish: 'Завершити →',
      doneTitle: 'Готово!',
...
const ru = {
  ...
  cards: {
    ...
    diagnosis: {
      ...
      lostEyebrow: 'Вы теряете ежемесячно',
      lostCap: 'это {low}–{high} клиентов, которые сейчас уходят к другим юристам',
      yearlyLabel: 'За год это',
      hoursChip: 'часов в месяц на поиск клиентов',
      noTimeChip: 'часов на поиск — вы растёте только на рекомендациях',
      clientsChip: 'клиентов ежемесячно проходят мимо вас',
      fixTitle: 'ЧТО ЭТО РЕШИТ',
      forLabel: 'Рассчитано для:',
      caseLabel: 'средний чек дела:',
      cta: 'Показать решение →',
      ...
      branch: {
        few_leads: {
          ...
          fix: 'Готовые заявки от клиентов в ваших направлениях + AI-продвижение в Google и рекламе.'
        },
        no_deals: {
          ...
          fix: 'Сильный публичный профиль, повышение рейтинга за прошлый опыт и топ в Google по вашему имени.'
        },
        routine: {
          ...
          fix: 'AI-аватар и контент-завод ведут ваш профиль и соцсети за вас, пока вы работаете с делами.'
        },
        no_system: {
          ...
          fix: 'CRM, защищённый мессенджер и AI-мониторинг — все обращения в одном месте, ничего не теряется.'
        }
      }
    },
    cta: {
    ...
    assessment: {
      ...
      tabBioNote: 'от 3 000 символов',
      cvPlaceholder: 'Нажмите, чтобы выбрать файл',
      cvHint: '.pdf / .doc / .docx',
      bioPh: 'Расскажите о своём опыте, образовании, специализации, известных делах, сертификатах и наградах. Чем больше деталей — тем сильнее профиль составит AI.',
      charCount: '{n} / {target} символов',
      finish: 'Завершить →',
      doneTitle: 'Готово!',
