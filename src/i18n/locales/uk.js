...
export default {
  ...
  slides: {
    ...
    assessment: {
      ...
      sub: 'Ми оцінили ваші відповіді на попередні запитання — що повніший профіль, то вищий ваш рейтинг і більше довіри від клієнтів на CONSULTANT.'
    },
    fullProfile: {
  ...
  cards: {
    ...
    aiPotential: {
      ...
      how: {
        ...
        clients: { t: 'Клієнти сервісу', d: 'Люди, що вже шукають юриста на CONSULTANT' }
      },
    ...
    fullProfile: {
      ...
      skipModal: {
        ...
        body: 'Без <strong>біо</strong> чи <strong>резюме</strong> наш AI не зможе скласти конкурентний профіль. Юристи, які пропускають цей крок, отримують <strong>значно менше запитів від клієнтів</strong> на CONSULTANT.<br><br>Це займе 2 хвилини й суттєво покращить ваш результат.',
