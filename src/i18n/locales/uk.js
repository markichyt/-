...
export default {
  ...
  slides: {
    ...
    videoProof: {
      q: 'Купуй <span class="accent">готові заявки</span> клієнтів',
      sub: 'Контакти відкриваються одразу — телефонуй і бери справу'
    },
    video1: {
      q: 'AI пише <span class="accent">експертні статті</span> за тебе',
      sub: 'Ставай помітним і приваблюй клієнтів'
    },
    video2: {
      q: 'Клієнти <span class="accent">знайдуть тебе в Google</span> першим',
      sub: 'Просто завантаж резюме — решту зробить AI'
    },
    videoAds: {
      q: 'Один клік — і ти <span class="accent">у всіх соцмережах</span>',
      sub: 'Більше охоплення — більше клієнтів'
    },
    videoQa: {
      q: 'Відповідай на <span class="accent">питання клієнтів</span>',
  ...
  cards: {
    photo: {
      ...
      videoTitle: 'Одне фото → AI-відеовізитка, що продає тебе 24/7',
      sampleLabel: 'Зразок',
