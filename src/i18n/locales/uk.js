...
export default {
  ...
  slides: {
    ...
    videoProof: {
      q: 'Купуйте клієнтів за <span class="accent">собівартістю</span>',
      sub: 'Не вистачає клієнтів? Купіть готову заявку, відкрийте її контакти й одразу телефонуйте — без реклами та команди.'
    },
    profession: {
  ...
  cards: {
    photo: {
      ...
      videoTitle: 'Навіщо потрібне фото? Подивіться 👇',
      sampleLabel: 'Зразок',
